...
const TYPE_CONFIG: Record<string, { icon: string; color: string; label: string }> = {
  ...
  new_job_request:     { icon: 'work',              color: '#2563EB', label: 'Job Request'        },
      ...
      {modal && (
        ...
        >
          ...
          >
            ...
            <h3 className="text-[17px] font-black text-on-surface mb-2">{modal.title ?? cfg(modal.type).label}</h3>
